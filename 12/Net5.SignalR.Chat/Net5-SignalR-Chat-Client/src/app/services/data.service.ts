...
export class DataService {
  usersURL = 'https://localhost:44364/api/Users';
  roomsURL = 'https://localhost:44364/api/Rooms';
  chatsURL = 'https://localhost:44364/api/Chats';
  roomUsersURL = 'https://localhost:44364/api/RoomUsers';
